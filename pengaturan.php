                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',pimpinan='$pimpinan',id='$id',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="pimpinan" type="text" class="validate" name="pimpinan" value="<?php echo $row['kepsek']; ?>" required>
                                            <?php
                                            ...
                                            ?>
                                        <label for="pimpinan">pimpinan divisi</label>
                                    </div>
                                    <div class="input-field col s6">
