    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jl. Pierre Tendean No.1, Wenang Utara, Kec. Wenang, Kota Manado </span>';
            ...
            <div id="lead">
                <p>Pimpinan Divisi</p>
                <div style="height: 50px;"></div>';
                $query = mysqli_query($config, "SELECT pimpinan, id FROM tbl_instansi");
                list($pimpinan,$id) = mysqli_fetch_array($query);
                if(!empty($pimpinan)){
                    echo '<p class="lead">'.$pimpinan.'</p>';
                } else {
                    echo '<p class="lead">Noldy Dandel</p>';
                }
                if(!empty($id)){
                    echo '<p>id. '.$id.'</p>';
                } else {
